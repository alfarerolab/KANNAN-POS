...
export function construirTicketRestaurante(args: {
  ...
  return {
    ...
    total: venta.total,
    costoEmpaque: pedido.costoEmpaque ?? undefined,
    costoDomicilio: pedido.costoDomicilio ?? undefined,
    tipoServicio: pedido.tipoServicio ?? undefined,
    direccionEnvio: pedido.direccionEnvio ?? undefined,
    telefonoEnvio: pedido.telefonoEnvio ?? undefined,
