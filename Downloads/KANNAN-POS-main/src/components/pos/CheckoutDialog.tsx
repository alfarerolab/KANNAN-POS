              ...
              <>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {METODOS_PAGO.filter(m => !["NEQUI", "DAVIPLATA"].includes(m.id)).map((metodo) => {
                      const isTransferencia = metodo.id === "TRANSFERENCIA";
                      const isTransferenciaSelected = ["TRANSFERENCIA", "NEQUI", "DAVIPLATA"].includes(metodoPagoSeleccionado);
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 p-3 rounded-lg border-2 border-dashed">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {METODOS_PAGO.filter(m => !["NEQUI", "DAVIPLATA"].includes(m.id)).map((metodo) => {
                      const isTransferencia = metodo.id === "TRANSFERENCIA";
                      const isTransferenciaSelected = ["TRANSFERENCIA", "NEQUI", "DAVIPLATA"].includes(nuevoMetodo);
                  ...
                  {["TRANSFERENCIA", "NEQUI", "DAVIPLATA"].includes(nuevoMetodo) && (
